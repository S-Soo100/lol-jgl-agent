...
## ⚠️ 증류 시 원칙 — 원리 vs 타이밍을 구분할 것
- **원리(수싸움·선턴·덧셈·위치잡기)는 패치와 무관하게 유효** → 그대로 증류.
- **타이밍 숫자(오브젝트 스폰·XP 등)는 영상 시점의 패치 기준이라 낡을 수 있음** → **반드시 현재 패치로 재확인 후 기록.**
- 실사례: 영상의 "5:20 유충"은 구 패치. **현재(2026-07 시즌2): 유충 8분·경기당 1회, 전령 15분.** ([05](principles/05-timing-and-tempo.md) 상단 경고 참조)
